...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: const Color(0xFFB2EBF2),////esta es otra forma alternativa de poner : colorTheme.of(context).primaryColor
        ...
        child: Column(
          children: [
            ...
            Card(
              ...
              color: const Color.fromARGB(255, 122, 203, 214),
              child:ListView(
                shrinkWrap: true,
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        ...
                        colors: [
                          Color.fromARGB(255, 159, 218, 193),
                          Color.fromARGB(255, 108, 230, 169),
                        ]),
